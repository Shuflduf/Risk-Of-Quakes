...
func _enter_tree() -> void:
	...
	add_custom_type(
		"FuncGodotMap", "Node3D", preload("res://addons/func_godot/src/map/func_godot_map.gd"), null
	)
	...
	if not ProjectSettings.has_setting("func_godot/default_inverse_scale_factor"):
		...
		var property_info = {"name": "func_godot/default_inverse_scale_factor", "type": TYPE_FLOAT}
		ProjectSettings.add_property_info(property_info)
	...
	if not ProjectSettings.has_setting("func_godot/model_point_class_save_path"):
		...
		var property_info = {"name": "func_godot/model_point_class_save_path", "type": TYPE_STRING}
		ProjectSettings.add_property_info(property_info)
...
func func_godot_map_build_complete(func_godot_map: FuncGodotMap) -> void:
	...
	if func_godot_map.is_connected(
		"build_complete", Callable(self, "func_godot_map_build_complete")
	):
