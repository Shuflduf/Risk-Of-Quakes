...
enum TagMatchType { TEXTURE, CLASSNAME }  ## Tag applies to any brush face with a texture matching the texture name.  ## Tag applies to any brush entity with a class name matching the tag pattern.
